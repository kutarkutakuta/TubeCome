      ...
      <div className="space-y-4">
        ...
        <div className="win-window win-inset p-4">
          <ul className="list-disc list-inside text-sm space-y-2 text-[var(--fg-primary)]">
            <li><strong>チャンネルの登録</strong>：<Link href="/" className="text-blue-600 underline">ホーム</Link>でYouTubeの「チャンネルURL」または「チャンネルID」を追加します。</li>
            <li><strong>チャンネル一覧</strong>：登録したチャンネルの一覧が表示されます。チャンネル内に新着動画があればバッジが表示されます。</li>
            ...
            <li><strong>コメント一覧</strong>：動画の詳細とコメントを閲覧できます。読んだコメントの位置を記憶して再訪問時に位置を復元します。</li>
          </ul>
        </div>

        {/* スマホ共有のやり方 */}
        <div className="win-window win-title-bar mb-2 bg-slate-100 border-b border-slate-200 px-3 py-1 rounded-sm">
          <div className="font-bold text-sm">📲 スマホで YouTube を共有してチャンネル登録</div>
        </div>
        <div className="win-window win-inset p-4">
          <ul className="list-disc list-inside text-sm space-y-2 text-[var(--fg-primary)]">
            ...
            <li><strong>iPhone (iOS)</strong>：
              <ol className="list-inside ml-4 mt-1 space-y-1">
                <li>YouTubeアプリでチャンネルページを開き、<strong>共有</strong>で「リンクをコピー」して<strong>TubeCome</strong>の登録フォームに貼り付けてください。</li>
              </ol>
            </li>
          </ul>
        </div>
